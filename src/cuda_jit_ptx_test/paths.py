...
package_name = "cuda_jit_ptx_test"

def get_cache_ptx_dir():
    # Get the user-specific cache directory for your package
    cache_dir = user_cache_dir(package_name)
    ...
    return ptx_cache_dir

def get_cache_cubin_dir():
    # Get the user-specific cache directory for your package
    cache_dir = user_cache_dir(package_name)
    
    # Create a subdirectory for PTX files
    ptx_cache_dir = os.path.join(cache_dir, "cubin")
